...
export default function SelectUserDialog({ setStudent }: Props) {
  ...
  return (
    <>
      <button onClick={handleOpen}  className="add-btn rounded-lg text-[20px] cursor-pointer text-white pt-3 pb-2.5 px-8 bg-blue-400 mb-3 -mt-4 ">
